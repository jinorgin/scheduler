...
//InterviewerListItem
    ...
    storiesOf("InterviewerListItem", module)
      ...
      storiesOf("InterviewerList", module)
        ...
        .add("Status", () => <Status />)
        .add("Error", () => <Error />)
        .add("Error", () => <Error onCancel={action("onCancel")}/>)
        .add("Form - Create", () => (
              <Form
                interviewers={interviewers}
                onSave={action("onSave")} // Component calls, don't execute here
                onCancel={action("onCancel")} // Component calls, don't execute here
              />
            ))
            .add("Form - Edit", () => (
              <Form
